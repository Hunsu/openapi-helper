...
class OpenApiMethodIndex : FileBasedIndexExtension<String, String>() {
    ...
    override fun getVersion(): Int = 24
    ...
    override fun getIndexer(): DataIndexer<String, String, FileContent> = DataIndexer { fileContent ->
        ...
        if ((fileContent.file.extension == "java" || fileContent.file.extension == "kt")) {
            if (
            ...
            } else if (text.contains("This class is auto generated by OpenAPI Generator")) {
                val methodRegex = if (fileContent.file.extension == "kt") {
                    Regex("""fun\s+(\w+)\s*\(""")
                } else {
                ...
                for (match in methodRegex.findAll(text)) {
                    ...
                    if (methodName != null) {
                        result[methodName] = projectRelativePath
                    }
                }
            }
        }
